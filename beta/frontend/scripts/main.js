var question_bank_array = new Array();
        ...
        if (req.readyState == 4) {
            ...
            if (req.status == 200) {
                ...
                for(var i=0;i<json_response.length;i++) {
                    ...
                    cell1.appendChild(document.createTextNode(json_response[i].topic));
                    cell2.appendChild(document.createTextNode(json_response[i].difficulty));
                    cell3.appendChild(document.createTextNode(json_response[i].questionbody));
